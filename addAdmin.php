...
<head>
    ...
    <title>Add Admin | Employee System</title>
            ...
            <div class="flex-1 md:ml-64 p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <nav class="text-sm text-gray-500">
                        <a href="#" class="hover:text-blue-600">Home</a> > <span class="text-gray-700">Add Admin</span>
                    </nav>
                </div>

                <!-- Add Admin Form -->
                <div class="bg-white rounded-lg shadow card-hover p-6 mb-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">Add New Admin</h2>
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="password" name="pass" class="w-full p-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow card-hover p-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">View All Admins</h2>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left">
                            <thead>
                                <tr class="border-b">
                                    <th class="py-3 px-4 text-gray-600">Sr. No.</th>
                                    <th class="py-3 px-4 text-gray-600">First Name</th>
                                    <th class="py-3 px-4 text-gray-600">Last Name</th>
                                    <th class="py-3 px-4 text-gray-600">Email</th>
                                    <th class="py-3 px-4 text-gray-600">Joining Date</th>
                            ...
                            <tbody>
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">Shah</td>
                                    <td class="py-3 px-4">rshah2399@gmail.com</td>
                                    <td class="py-3 px-4">02/01/2020</td>
                                    <td class="py-3 px-4">
                                        <a href="editAdmin.php" class="text-blue-600 hover:text-blue-800 mr-2 update">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="deleteAdmin.php" class="text-red-600 hover:text-red-800 delete">
