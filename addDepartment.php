...
<head>
    ...
    <title>Add Department | Employee System</title>
            ...
            <div class="flex-1 md:ml-64 p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <nav class="text-sm text-gray-500">
                        <a href="#" class="hover:text-blue-600">Home</a> > <span class="text-gray-700">Add Department</span>
                    </nav>
                </div>

                <!-- Add Department Form -->
                <div class="bg-white rounded-lg shadow card-hover p-6 mb-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">Add New Department</h2>
                    <form>
                ...
                <div class="bg-white rounded-lg shadow card-hover p-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">View All Departments</h2>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        <a href="editDepartment.php" class="text-blue-600 hover:text-blue-800 mr-2 update">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="deleteDepartment.php" class="text-red-600 hover:text-red-800 delete">
