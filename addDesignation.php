...
<head>
    ...
    <title>Add Designation | Employee System</title>
        ...
        <div class="flex min-h-screen content">
            ...
            <div class="flex-1 md:ml-64 p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold text-gray-800">Add Designation</h1>
                    <nav class="text-sm text-gray-500">
                        <a href="#" class="hover:text-blue-600">Home</a> > <span class="text-gray-700">Add Designation</span>
                    </nav>
                </div>

                <!-- Add Designation Form -->
                <div class="bg-white rounded-lg shadow card-hover p-6 mb-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">Add New Designation</h2>
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Designation</label>
                                <input type="text" name="designationadd" class="w-full p-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                        <button type="submit" class="mt-4 bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-200 flex items-center">
                            <i class="fas fa-plus-circle mr-2"></i> Add Designation
                        </button>
                    </form>
                </div>
                ...
                <div class="bg-white rounded-lg shadow card-hover p-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">View All Designations</h2>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        <a href="editDesignation.php" class="text-blue-600 hover:text-blue-800 mr-2 update">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="deleteDesignation.php" class="text-red-600 hover:text-red-800 delete">
