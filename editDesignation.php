...
<head>
    ...
    <title>Edit Designation | Employee System</title>
        ...
        <div class="flex min-h-screen content">
            ...
            <div class="flex-1 md:ml-64 p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold text-gray-800">Edit Designation</h1>
                    <nav class="text-sm text-gray-500">
                        <a href="#" class="hover:text-blue-600">Home</a> > 
                        <a href="addDesignation.php" class="hover:text-blue-600">Add Designation</a> > 
                        <span class="text-gray-700">Edit Designation</span>
                    </nav>
                </div>

                <!-- Edit Designation Form -->
                <div class="bg-white rounded-lg shadow card-hover p-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">Edit Designation</h2>
                    <form>
                        ...
                        <div class="mt-4 flex space-x-4 justify-end">
                            ...
                            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-200 flex items-center">
                                <i class="fas fa-plus-circle mr-2"></i> Edit Designation
                            </button>
                        </div>
                    </form>
                </div>
