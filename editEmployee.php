...
<head>
    ...
    <title>Edit Employee | Employee System</title>
            ...
            <div class="flex-1 md:ml-64 p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <nav class="text-sm text-gray-500">
                        ...
                        <a href="addEmployee.php" class="hover:text-blue-600">Add Employee</a> > 
                        <span class="text-gray-700">Edit Employee</span>
                    </nav>
                </div>

                <!-- Edit Employee Form -->
                <div class="bg-white rounded-lg shadow card-hover p-6">
                    <h2 class="text-xl font-semibold text-blue-600 mb-4">Edit Employee</h2>
                    <form>
                        <!-- Personal Details -->
                        ...
                        <div class="mt-4 flex space-x-4 justify-end">
                            ...
                            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-200 flex items-center">
                                <i class="fas fa-plus-circle mr-2"></i> Edit Employee
                            </button>
                        </div>
                    </form>
                </div>
